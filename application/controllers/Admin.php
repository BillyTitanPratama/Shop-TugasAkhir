...
class Admin extends CI_Controller
{
	...
	function kategori_produk()
	{
		...
		$data['title'] = 'Kategori Produk - GG Store';
	...
	function tambah_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Kategori Produk - GG Store';
	...
	function edit_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Produk - GG Store';
	...
	function tambah_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Produk - GG Store';
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function tambah_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Rekening - GG Store';
	...
	function edit_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Rekening - GG Store';
	...
	function tambah_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Supplier - GG Store';
	...
	function edit_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Supplier - GG Store';
	...
	function edit_konsumen()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Konsumen - GG Store';
	...
	function detail_konsumen()
	{
		...
		$data['title'] = 'Detail Konsumen - GG Store';
	...
	function pesanan_dikirim()
	{
		...
		$data['title'] = 'Masukan Resi - GG Store';
	...
	function website()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Identitas Website - GG Store';
	...
	function menu()
	{
		...
		$data['title'] = 'Menu Website - GG Store';
	...
	function tambah_menu()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Menu Website - GG Store';
	...
	function edit_menu()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Menu Website - GG Store';
			$data['record'] = $this->model_menu->menu_utama();
	...
	function logo()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Logo Website - GG Store';
	...
	function tambah_slider()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Slider - GG Store';
	...
	function edit_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Slider - GG Store';
	...
	function tambah_halaman()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Halaman Baru - GG Store';
	...
	function edit_halaman()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Halaman Baru - GG Store';
	...
	function tambah_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Artikel - GG Store';
	...
	function edit_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Artikel - GG Store';
			$data['tag'] = $this->model_artikel->tag_artikel();
			$data['record'] = $this->model_artikel->kategori_artikel();
	...
	function tambah_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Tag - GG Store';
	...
	function edit_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Pengguna - GG Store';
	...
	function users()
	{
		$data['title'] = 'Manajemen Pengguna - GG Store';
	...
	function tambah_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Pengguna - GG Store';
	...
	function laporan()
	{
		$data['title'] = 'Laporan Penjualan - GG Store';
	...
	function newsletter()
	{
		...
		$data['title'] = 'Newsletter - GG Store';
	...
	function tambah_newsletter()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$config['smtp_host'] = "mail.GG.com";
			$config['smtp_crypto'] = "ssl";
			$config['smtp_port'] = "465";
			$config['smtp_user'] = "demo-ecommerce@GG.com";
			$config['smtp_pass'] = "demo-ecommerce";
			$config['charset'] = "iso-8859-1";
			$config['mailtype'] = "html";
			$config['newline'] = "\r\n";
			$ci->email->initialize($config);
			$ci->email->from('demo-ecommerce@GG.com', "GG Store");
			...
			$data['title'] = 'Kirim News Letter - GG Store';
	...
	function lihat_newsletter()
	{
		...
		$data['title'] = 'Detail Berita - GG Store';
	...
	function subscriber()
	{
		$data['title'] = 'Subscriber - GG Store';
