  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <div class="bg-primary brand-link">
        <a href="">
          <img src="<?= base_url('assets/images/logo/logos.png') ?>" alt="GGStore" class="brand-image img-circle elevation-3 bg-white" style="opacity: .8">
    ...
    <footer class="main-footer">
      <strong>&copy; <?= date('Y') ?> <a href="https://www.instagram.com/billy_titan/" target="_BLANK">Billy Titan</a></strong>
